...
async def _manage(_, msg):
    ...
    how += '2) Visit @KGN_OFFICIAL and define your problem **completely**, i.e, what you expected and what happened instead.'
    how += "If you don't get a reply, tag an admin."
    await msg.reply(
        how,
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('Support', url='https://t.me/KGN_OFFICIAL')]
        ]),
        quote=True
    )
